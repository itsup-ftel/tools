...
echo      %G%5.%Res% Kiem tra Bitlocker   %G%11.%Res% Restart Explorer    %G%17.%Res% Xem Pass Wi-Fi       %G%23.%Res% -11-------------
...
:installappfree
cls:: 2. Kiem tra va Tu dong cai dat Winget
...
:: 2. Kiem tra va Tu dong cai dat/Cap nhat Winget
winget --version >nul 2>&1
if %errorLevel% neq 0 (
    echo [!] Khong tim thay Winget. Dang tien hanh tai va cai dat...
    powershell -NoProfile -ExecutionPolicy Bypass -Command ^
...
:: Lam moi nguon tai de tranh loi "Source not found"
